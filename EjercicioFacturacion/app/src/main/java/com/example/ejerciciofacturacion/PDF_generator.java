...
public class PDF_generator {
    ...
    private Paint paint;
    private Paint Cuadrado;
    private Paint categoria;

    private int numpagina;
    private int finpagina;
    public void crearPDF(Context context, String texto, ArrayList<ArrayList<String>> tablita,String sumartotal) {
       ...
       categoria = new Paint();
        ...
        int valor = 0;
        int contador = 0;
        int aumento_fin_pagina = 0;
        finpagina = 1;
        for (int j = 0; j<tablita.size();j++ ){
            aumento_fin_pagina++;
            if (aumento_fin_pagina == 10) {
                finpagina++;
                aumento_fin_pagina = 0;
            }
        }
        dibujos_base (texto,numpagina,finpagina);
    ...
    public void dibujos_base (String texto,int numeropagina,int finpagina){
        String original = "ORIGINAL";
        String factura = "FACTURA";
        String numpagina = "pagina Nª" + String.valueOf(numeropagina)+ "/"+String.valueOf(finpagina);
        ...
        canvas.drawText(numpagina, 480, 118, paint);
    ...
    public void totales(String sumartotal){
